...
#converter{height:100vh;background-color:#f8f8f8;border:1px solid #dedede;border-left:0;border-right:0;padding-top:60px}
...
.post h2.post-title{width:100%;padding:0;margin-bottom:0;font-size:18px;text-align:left;border-bottom:0}
.posts-thumb{position:relative;margin-right:10px;padding-top:4px;float:left;overflow:hidden}
/*]]>*/
</style>
</b:if>
...
.breadcrumb{margin:20px 0 5px;}
  ...
  <b:if cond='data:blog.url == &quot;https://ojolelet.blogspot.com/p/generate_6.html&quot;'>
<style type='text/css'>
.postmeta,h2.post-title{position:fixed;top:-1000px;left:-1000px}
...
var str = currentURL;
  var res = str.replace("https://ojolelet.blogspot.com/p/generate_6.html?url=", "");
$(".Visit_Link").hide();
function changeLink(){
...
<div class='light-heading1'>Mungkin halaman telah dihapus. Kami mohon maaf atas ketidaknyamanan ini.</div><br/>
  <div class='light-heading2'>Silahkan Klik <a expr:href='data:blog.homepageUrl' title='Homepage'><span style='background:#ddd;border:1px solid #aaa;border-radius:3px;padding:2px 5px'><b>DI SINI</b></span></a> untuk kembali ke homepage <b><data:blog.title/></b>.<br/>
...
<script type='text/javascript'>
  ...
  var GOOG_FIXURL_SITE = &quot;<data:blog.homepageUrl/>&quot;
</script>
...
<header itemscope='itemscope' itemtype='https://schema.org/WPHeader'>
      <b:section class='header' id='header' maxwidgets='1' showaddelement='no'>
        <b:widget id='Header1' locked='true' title='Safelink Bos (Header)' type='Header' version='1'>
          <b:widget-settings>
...
<b:else/>
  ...
  <div class='descriptionwrapper'>
    <p class='description' itemprop='description'><span><data:description/></span></p>
      ...
      <a expr:href='data:blog.homepageUrl' expr:title='data:title' itemprop='url'><span itemprop='name'>Safelink</span></a>
</b:includable>
        </b:widget>
      </b:section>
      </header>
        ...
        <div class='collapse navbar-collapse' id='navbar'>
          <ul class='nav navbar-nav'>
            <li><a href='http://www.safelink.ga/p/about.html' title='About'>About</a></li>
            <li><a href='http://www.safelink.ga/p/contact.html' title='Contact'>Contact</a></li>
            <li><a href='http://www.safelink.ga/p/privacy.html' title='Privacy'>Privacy</a></li>
            <li><a href='http://www.safelink.ga/p/disclaimer.html' title='Disclaimer'>Disclaimer</a></li>
            <li><a href='http://www.safelink.ga/p/sitemap.html' title='Sitemaps'>Sitemaps</a></li>
          </ul>
          <ul class='nav navbar-nav navbar-right'>
            <b:if cond='data:blog.url == &quot;https://ojolelet.blogspot.com/p/generate_6.html&quot;'>
            <li><a data-target='.how-to-use' data-toggle='modal' href='javascript:void(0)' title='How To Use'>How To Use</a></li>
            </b:if>
            <li><a data-target='.how-to-get' data-toggle='modal' href='javascript:void(0)' title='How To Get'>How To Get</a></li>
            <b:if cond='data:blog.pageType != &quot;item&quot; and data:blog.pageType != &quot;static_page&quot;'>
            <li><a href='https://keneono.blogspot.com' role='button' title='Blog'>Blog</a></li>
            </b:if>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
...
<div aria-labelledby='mySmallModalLabel' class='modal fade contact' role='dialog' tabindex='-1'>
  <div class='modal-dialog modal-sm'>
    <div class='modal-content'>
      <div class='modal-header'> <button aria-label='Close' class='close' data-dismiss='modal' type='button'><span aria-hidden='true'>&#215;</span></button> <h4 class='modal-title' id='mySmallModalLabel'>Contact Us</h4> </div>
...
<textarea cols='25' id='ContactForm1_contact-form-email-message' name='email-message' placeholder='Message' rows='5'/><br/>
...
<div aria-labelledby='myLargeModalLabel' class='modal fade how-to-use' role='dialog' tabindex='-1'>
  <div class='modal-dialog modal-lg'>
    <div class='modal-content'>
      <div class='modal-header'> <button aria-label='Close' class='close' data-dismiss='modal' type='button'><span aria-hidden='true'>&#215;</span></button> <h4 class='modal-title' id='myLargeModalLabel'>How To Use This Safe Link Converter On Your Blog</h4> </div>
      <div class='modal-body text-left'>
...
<script type='text/javascript'>
//<![CDATA[
protected_links = "www.tasiunapk.com,blogspot.com,youtube.com,facebook.com,google.com,twitter.com"; 
  (function() {
    var sl = document.createElement('script');
    sl.type = 'text/javascript'; sl.async = true;
    sl.src = 'https://cdn.rawgit.com/lucyver/vian/8ca121e6/ojolelet.js';
...
<div aria-labelledby='mySmallModalLabel3' class='modal fade how-to-get' role='dialog' tabindex='-1'>
  <div class='modal-dialog modal-sm'>
    <div class='modal-content'>
      <div class='modal-header'> <button aria-label='Close' class='close' data-dismiss='modal' type='button'><span aria-hidden='true'>&#215;</span></button> <h4 class='modal-title' id='mySmallModalLabel3'><strong>How to get this Safelink Converter Blogger Theme</strong>.</h4> </div>
      <div class='modal-body text-left'>
...
<div class='container'>
  <div class='col-md-8 col-md-offset-2'>
    ...
    <div class='panel panel-primary'>
      <div class='panel-heading'><div class='panel-title text-center'><h2><i class='fa fa-shield'/> <strong>Safe Link Converter</strong></h2></div></div>
...
<button class='btn btn-primary' data-target='#safeLINK' data-toggle='collapse' type='button'><i class='fa fa-shield'/> <strong>Safe Link Now!</strong></button>
</span>
          </div>
        </div>
        <script src='https://cdn.rawgit.com/lucyver/vian/8ca121e6/ojolelet.js' type='text/javascript'/>
        <div class='collapse' id='safeLINK'>
          <div class='form-group has-success'>
            <div class='input-group'>
              <span class='input-group-addon'><strong>Result:</strong> <i aria-hidden='true' class='fa fa-check'/></span>
            <input class='form-control' id='resultLink' onclick='this.focus();this.select()' readonly='readonly' required='required' type='text'/></div>
            <br/>
            <button class='alert alert-dismissible alert-success btn-lg btn-block text-center'><i aria-hidden='true' class='fa fa-thumbs-o-up'/> <strong>Well done!</strong> you have successfully encrypted your link.</button>
            <div class='text-center'>
            <button class='btn btn-sm btn-success' data-clipboard-target='resultLink' data-target='#safeLINK' data-toggle='collapse' id='btnCopy' type='submit'><i aria-hidden='true' class='fa fa-files-o'/> <strong>Copy your link to clipboard!</strong></button>
            </div>
          </div>
        </div>
      </div>
...
//<![CDATA[
  ...
  input.onkeyup = function() {
    if (input.value != "") {
      output.value = "https://ojolelet.blogspot.com/p/generate_6.html?url=" + Base64.encode(this.value); //change with your link
    } else {
      output.value = "";
    }
  }
...
<div class='panel panel-info'>
  <div class='panel-heading'><h2 class='panel-title'><i aria-hidden='true' class='fa fa-question-circle-o'/> <strong>How to use our tool:</strong></h2></div>
  <div class='panel-body'>
<ol>
<li>Put the link on the <strong>Safe Link Converter</strong> box with <strong>http://</strong> or <strong>https://</strong></li>
<li>Use <kbd><kbd>CTRL</kbd> + <kbd>V</kbd></kbd> on keyboard to put the link.</li>
<li>Click the <strong>Safe Link Now!</strong> button to get encrypted link.</li>
<li>Click the <strong>Copy your link to clipboard!</strong></li>
<li>Done.</li>
</ol>
  </div>
</div>
...
<b:if cond='data:blog.pageType != &quot;item&quot; and data:blog.pageType != &quot;static_page&quot;'>
<div class='container'>
  <div class='alert alert-info btn-lg btn-block text-center'><h2><strong>Blog Posts</strong></h2></div>
  </div>
</b:if>
...
<span class='post-author vcard' itemprop='author' itemscope='itemscope' itemtype='https://schema.org/Person'> 
    ...
    <span class='clock'> <i class='fa fa-calendar'/> <a class='updated' expr:href='data:post.url' rel='bookmark' title='permanent link'><abbr class='published' expr:title='data:post.timestampISO8601' itemprop='datePublished'> <data:post.timestamp/></abbr></a></span></h3>
</div>
  ...
  <div class='widget-content popular-posts'>
    ...
    <b:include name='quickedit'/>
           ...
           <b:widget cond='!data:view.isPost' id='PageList1' locked='false' title='' type='PageList'>
             <b:widget-settings>
               <b:widget-setting name='pageListJson'><![CDATA[{'home': {'href': 'https://ojolelet.blogspot.com/', 'title': 'Beranda', 'position': 0}}]]></b:widget-setting>
...
<footer class='footer'>
      <div class='container'>
        <div class='row'>
        <div class='col-md-4'>Copyright &#169; <script>document.write((new Date()).getFullYear());</script> <a expr:href='data:blog.homepageUrl' expr:title='data:blog.title'><data:blog.title/></a></div>
